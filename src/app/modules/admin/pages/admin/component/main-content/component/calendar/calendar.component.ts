...
import { Accounting_Document, POSTReserva, Reserva, Room, ClosedSchedule } from 'src/app/modules/admin/pages/admin/component/main-content/component/calendar/interface/ireserva';
import { AdminService } from 'src/app/modules/admin/services/admin.service';
import { Client } from 'src/app/modules/admin/pages/admin/component/main-content/component/clients/interface/iclient';
import { NewReservationComponent } from '../calendar/components/new-reservation/new-reservation.component';
import { ClosedDateComponent } from '../calendar/components/closed-date/closed-date.component';
...
export class CalendarComponent implements OnInit{
 ...
 @ViewChild(NewReservationComponent, { static: false })
  newReservationComponent: NewReservationComponent =
    new NewReservationComponent(this.adminService,
      this.calendarService, this.messageService);

  @ViewChild(ClosedDateComponent, { static: false })
  closedDateComponent: ClosedDateComponent =
    new ClosedDateComponent(this.calendarService, this.messageService);
    ...
    async handleEventClick(clickInfo: EventClickArg) {
      ...
      if(id_Reservation != 0){
        this.coreNuevo();
        let reserva:Reserva = await this.calendarService.GetReservationId(id_Reservation);
        if (reserva != null) {
          let pago:Accounting_Document = await this.calendarService.GetReservationAcc(reserva.id);
          console.log("pago");
          console.log(pago);
          console.log("reserva.checkin - "+ reserva.checkin);
          this.newReservationComponent.componentsInitials('EDITAR','RESERVA',reserva,pago);
        }
    ...
    //Form Reserva
    coreNuevo() {
      this.newReservationComponent.componentsInitials('NUEVA','RESERVA', null, null);
    }
    ...
    getReservas() {
      this.calendarService.GetReservation(null, null).then((reservas) => {
    ...
    getClosedHours(){
      this.calendarService.GetClosedSchedule().then((closed_schedules) => {
